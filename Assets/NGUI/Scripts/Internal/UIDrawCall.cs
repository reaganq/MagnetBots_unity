...
public class UIDrawCall : MonoBehaviour
{
	public enum Clipping
	{
		...
		DeskewedHardClip, // Duplicate of HardClip, hacked up to clip in screen space instead of skew space
	}
	...
	void UpdateMaterials ()
	{
		...
		if (useClipping)
		{
			...
			if (mClipping != Clipping.None)
			{
				...
				else if (mClipping == Clipping.DeskewedHardClip) shader = Shader.Find(shaderName + deskewedhard);
